...
class ProductDepracated {
  ...
  static ProductDepracated fromSnapshot(DocumentSnapshot snap){
    ProductDepracated  product = ProductDepracated(
  ...
  ProductDepracated.fromJson(Map<String, Object?> json)
      : this(
...
productQuery({category}) {
  return FirebaseFirestore.instance.collection('Products')
      .where('approved', isEqualTo: true).where('category', isEqualTo: category).withConverter<ProductDepracated>(
    fromFirestore: (snapshot, options) =>
        ProductDepracated.fromJson(snapshot.data()!),
